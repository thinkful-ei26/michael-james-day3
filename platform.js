...
<html lang="en">
  ...
  <link crossorigin="anonymous" media="all" integrity="sha512-gdS9o5ay+wYKsyObZ6AY3pLEXAftLt/9DOTAmRX1/efIrstGP70ENBr0k9qKDEmE7oYcE+F2kYc1kto4F7AXbA==" rel="stylesheet" href="https://assets-cdn.github.com/assets/github-a17edf1d0ba28386fb9eab7a1e0b1ef7.css" />
  ...
  <title>bestiejs/platform.js: A platform detection library.</title>
    <meta name="description" content="A platform detection library. Contribute to bestiejs/platform.js development by creating an account on GitHub.">
    <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
  <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
  <meta property="fb:app_id" content="1401488693436528">

    
    <meta property="og:image" content="https://avatars3.githubusercontent.com/u/802850?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="bestiejs/platform.js" /><meta property="og:url" content="https://github.com/bestiejs/platform.js" /><meta property="og:description" content="A platform detection library. Contribute to bestiejs/platform.js development by creating an account on GitHub." />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzMwMTE4MTA2OmUzNmU2YTFiYzU0NGUwZTdiMjM1OWRiYjk4MTA5NzMyY2FkMWYzNmU2MDJiNzAzZjI3NjY4OWJiYjQ3NzVjY2Y=--e9dfd7b205cf5f22b4ec723db259e4bfde3433ae">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="F43B:4D5D:12B4EBD:2398581:5BCA7D52" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="F43B:4D5D:12B4EBD:2398581:5BCA7D52" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="43457025" /><meta name="octolytics-actor-login" content="Fortiam" /><meta name="octolytics-actor-hash" content="c4f4c052752fb94b08af89cfa36db0e1d6d4a8cbf9846223bbe82897ca872e0f" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="userId" content="8176a77f7ba9c741bd987b1a1a1ca2f1" %>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="Fortiam">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="e56f3e86c93e80ed8d239e86674929820756a37c">

  <meta http-equiv="x-pjax-version" content="07b591b8e3d421ffec91983dc2f1bf38">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="1800453" data-scoped-search-url="/bestiejs/platform.js/search" data-unscoped-search-url="/search" action="/bestiejs/platform.js/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=HoRAc/62+0gmyWpRsZJ9g8pYp73bh9T58FQXxXUwb/1ky1w+lYcZtROX+GBuV6LIvPgIRh1BfahO5ZxmWtitlA=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:43457025" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    ...
    <a role="menuitem" class="dropdown-item" href="/bestiejs/platform.js/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@Fortiam" class="avatar float-left mr-1" src="https://avatars3.githubusercontent.com/u/43457025?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          <li class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="/Fortiam" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">Fortiam</strong></a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="/Fortiam" data-ga-click="Header, go to profile, text:your profile">Your profile</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/Fortiam?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a></li>


          <li><a role="menuitem" class="dropdown-item" href="/Fortiam?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
            <li><a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, your gists, text:your gists">Your gists</a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">Help</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/settings/profile" data-ga-click="Header, go to settings, icon:settings">Settings</a></li>
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="j70yj9ce7q4Ph0t0/z/17JNqt04Q13Ulsnqs5BlaJDO6ARo+t30beaaUam/abDhtD+J9+eLbKI5ZGPCoT5CtHw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="bviTSoC1tByICjGK16TFK8KbGlbKzkwf8jL5Y0w6b8dbRLv74NZByyEZEJHy9wiqXhPQ4TjCEbQZUKUvGvDm6w==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" class="js-social-form js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="EUZ7+Fzq1LD5uczTldc1iXyPo5bpoy3au8OGDNQJ0q2bBpfxHiZMp3aqToD0izEjbtXLRUrt/25Or1Z72LNyLA==" />      <input type="hidden" name="repository_id" id="repository_id" value="1800453" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/bestiejs/platform.js/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="ADxfsiK/FozmM1/tKnQgcBkfYuOCC/9y5q5vy1xud6qk4RrXz9nIHmizMBSreZWQnLnisuTZCwQcNu5KWHfhwA==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/bestiejs/platform.js/stargazers"
           aria-label="2124 users starred this repository">
          2,124
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/bestiejs/platform.js/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="eBNjhS3RoljGvKOCA2ImjA+vK/jEkr4shVVX72PF5t0vpB23YJX5oDDqdFkH1LdgZAsuiEmMAg06B5d8/IJcNA==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/bestiejs/platform.js/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="fCQ7I5dGi1nsAR+SSV6SKz1LlcwqDLjPifCRJod7h17L5Cxrj+wIEyo69tXggOxBT3Yl9xk//UKPZHsdiI5GyA==" />
            <button
                type="submit"
                ...
                aria-label="Fork your own copy of bestiejs/platform.js to your account">
              <svg class="octicon octicon-repo-forked v-align-text-bottom" viewBox="0 0 10 16" version="1.1" width="10" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"/></svg>
              Fork
            </button>
</form>
    <a href="/bestiejs/platform.js/network/members" class="social-count"
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts /bestiejs/platform.js/pulse" href="/bestiejs/platform.js/pulse">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="BtnGroup-form" action="/bestiejs/platform.js/new/master" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="SXSGXTIGlCRaRvjEfVqK0wdio+eUS2M1YQn0iiOra3jgMKKPw2SXPDcXzrxFkDrp3eNE+pgCJ/RkqxHQZpWDYw==" />
    ...
    <div class="get-repo-modal dropdown-menu dropdown-menu-sw pb-0 js-toggler-container on js-get-repo-modal">
      ...
      <div class="get-repo-modal-options">
          <div class="clone-options https-clone-options">
              <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" action="/users/set_protocol?protocol_selector=ssh&amp;protocol_type=clone" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="kKBv0F2eKkCFPLGcAIc7lsyThDBAGIfCFTkKunTlr8j304EPOT1Kic6eWCygT9W5LQiz8/NTIlfdoAJ+VHj7eg==" /><button type="submit" class="btn-link btn-change-protocol js-toggler-target float-right">Use SSH</button></form>
  ...
  <input type="text" class="form-control input-monospace input-sm" data-autoselect value="https://github.com/bestiejs/platform.js.git" aria-label="Clone this repository at https://github.com/bestiejs/platform.js.git" readonly>
    ...
    <clipboard-copy value="https://github.com/bestiejs/platform.js.git" aria-label="Copy to clipboard" class="btn btn-sm">
      <svg class="octicon octicon-clippy" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M2 13h4v1H2v-1zm5-6H2v1h5V7zm2 3V8l-3 3 3 3v-2h5v-2H9zM4.5 9H2v1h2.5V9zM2 12h2.5v-1H2v1zm9 1h1v2c-.02.28-.11.52-.3.7-.19.18-.42.28-.7.3H1c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c0-1.11.89-2 2-2 1.11 0 2 .89 2 2h3c.55 0 1 .45 1 1v5h-1V6H1v9h10v-2zM2 5h8c0-.55-.45-1-1-1H8c-.55 0-1-.45-1-1s-.45-1-1-1-1 .45-1 1-.45 1-1 1H3c-.55 0-1 .45-1 1z"/></svg>
          ...
          <div class="clone-options ssh-clone-options">
              ...
              <div class="input-group">
  <input type="text" class="form-control input-monospace input-sm" data-autoselect value="git@github.com:bestiejs/platform.js.git" aria-label="Clone this repository at git@github.com:bestiejs/platform.js.git" readonly>
  <div class="input-group-button">
    <clipboard-copy value="git@github.com:bestiejs/platform.js.git" aria-label="Copy to clipboard" class="btn btn-sm">
      <svg class="octicon octicon-clippy" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M2 13h4v1H2v-1zm5-6H2v1h5V7zm2 3V8l-3 3 3 3v-2h5v-2H9zM4.5 9H2v1h2.5V9zM2 12h2.5v-1H2v1zm9 1h1v2c-.02.28-.11.52-.3.7-.19.18-.42.28-.7.3H1c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c0-1.11.89-2 2-2 1.11 0 2 .89 2 2h3c.55 0 1 .45 1 1v5h-1V6H1v9h10v-2zM2 5h8c0-.55-.45-1-1-1H8c-.55 0-1-.45-1-1s-.45-1-1-1-1 .45-1 1-.45 1-1 1H3c-.55 0-1 .45-1 1z"/></svg>
        ...
        <div class="mt-2">
            <a href="x-github-client://openRepo/https://github.com/bestiejs/platform.js" class="btn btn-outline get-repo-btn tooltipped tooltipped-s tooltipped-multiline js-get-repo" data-open-app="windows" aria-label="Clone bestiejs/platform.js to your computer and use it in GitHub Desktop.">
    Open in Desktop
  </a>
...
<div class="AvatarStack flex-self-start AvatarStack--two">
  <div class="AvatarStack-body" aria-label="joaocac and jdalton (non-author committer)">

        <a class="avatar" data-skip-pjax="true" data-hovercard-user-id="1316019" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/joaocac">
          <img height="20" width="20" alt="@joaocac" src="https://avatars2.githubusercontent.com/u/1316019?s=60&amp;v=4" />
</a>
    ...
    <div class="flex-auto f6 no-wrap mr-3">
      ...
      <a href="/bestiejs/platform.js/commits?author=joaocac"
     class="commit-author tooltipped tooltipped-s user-mention"
     aria-label="View all commits by joaocac">joaocac</a>
   ...
   and   <a href="/bestiejs/platform.js/commits?author=jdalton"
     ...
     aria-label="View all commits by jdalton">jdalton</a>
        ...
        <a data-pjax="true" title="Add Edge iOS and Edge Android browser detection (#158)" class="message" href="/bestiejs/platform.js/commit/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6">Add Edge iOS and Edge Android browser detection (</a><a class="issue-link js-issue-link" data-error-text="Failed to load issue title" data-id="357209010" data-permission-text="Issue title is private" data-url="https://github.com/bestiejs/platform.js/issues/158" href="https://github.com/bestiejs/platform.js/pull/158">#158</a><a data-pjax="true" title="Add Edge iOS and Edge Android browser detection (#158)" class="message" href="/bestiejs/platform.js/commit/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6">)</a>

    </div>
    <div class="no-wrap">
      Latest commit
      <a class="commit-tease-sha" href="/bestiejs/platform.js/commit/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6" data-pjax>
        1f400fb
      </a>
      <span itemprop="dateModified"><relative-time datetime="2018-09-07T07:09:35Z">Sep 7, 2018</relative-time></span>
    </div>
  </div>
...
<div class="file-wrap">
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/bestiejs/platform.js/tree/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6">Permalink</a>
    ...
    <tbody>
      <tr class="warning include-fragment-error">
        ...
        <tr class="js-navigation-item">
          ...
          <td class="content">
            <span class="css-truncate css-truncate-target"><a class="js-navigation-open" title="test" id="098f6bcd4621d373cade4e832627b4f6-a804bfee9d7bf012fda02f3587617c7200d00e74" href="/bestiejs/platform.js/tree/master/test">test</a></span>
          </td>
          <td class="message">
            <span class="css-truncate css-truncate-target">
                  <a data-pjax="true" title="Add Edge iOS and Edge Android browser detection (#158)" class="message" href="/bestiejs/platform.js/commit/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6">Add Edge iOS and Edge Android browser detection (</a><a class="issue-link js-issue-link" data-error-text="Failed to load issue title" data-id="357209010" data-permission-text="Issue title is private" data-url="https://github.com/bestiejs/platform.js/issues/158" href="https://github.com/bestiejs/platform.js/pull/158">#158</a><a data-pjax="true" title="Add Edge iOS and Edge Android browser detection (#158)" class="message" href="/bestiejs/platform.js/commit/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6">)</a>
          ...
          <td class="age">
            <span class="css-truncate css-truncate-target"><time-ago datetime="2018-09-07T07:09:35Z">Sep 7, 2018</time-ago></span>
          </td>
        </tr>
        <tr class="js-navigation-item">
          <td class="icon">
        ...
        <tr class="js-navigation-item">
          ...
          <td class="content">
            <span class="css-truncate css-truncate-target"><a class="js-navigation-open" title="package.json" id="b9cfc7f2cdf78a7f4b91a753d10865a2-ab2f3c32027c9aeb7b1dcbdafcf2a02d78be0685" href="/bestiejs/platform.js/blob/master/package.json">package.json</a></span>
          </td>
          <td class="message">
            <span class="css-truncate css-truncate-target">
                  <a data-pjax="true" title="Remove sites from copyright header and package.json." class="message" href="/bestiejs/platform.js/commit/815f51ec72eb93cfc7f2b2a914a6de97e24680cf">Remove sites from copyright header and package.json.</a>
            </span>
          </td>
          <td class="age">
            <span class="css-truncate css-truncate-target"><time-ago datetime="2018-07-03T20:21:25Z">Jul 3, 2018</time-ago></span>
          </td>
        </tr>
        <tr class="js-navigation-item">
          <td class="icon">
          ...
          <td class="content">
            <span class="css-truncate css-truncate-target"><a class="js-navigation-open" title="platform.js" id="91a2c0610b564e6bc59df037803a460b-937504a4555a6250fdf8ebce25a94411b08f3df9" href="/bestiejs/platform.js/blob/master/platform.js">platform.js</a></span>
          </td>
          <td class="message">
            <span class="css-truncate css-truncate-target">
                  <a data-pjax="true" title="Add Edge iOS and Edge Android browser detection (#158)" class="message" href="/bestiejs/platform.js/commit/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6">Add Edge iOS and Edge Android browser detection (</a><a class="issue-link js-issue-link" data-error-text="Failed to load issue title" data-id="357209010" data-permission-text="Issue title is private" data-url="https://github.com/bestiejs/platform.js/issues/158" href="https://github.com/bestiejs/platform.js/pull/158">#158</a><a data-pjax="true" title="Add Edge iOS and Edge Android browser detection (#158)" class="message" href="/bestiejs/platform.js/commit/1f400fbd81b80eaac1b5ad1e7d0daaac057fe8e6">)</a>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.28919s from unicorn-84fdfcdb4f-dz2gx">GitHub</span>, Inc.</li>
